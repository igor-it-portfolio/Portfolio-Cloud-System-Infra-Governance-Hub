...
* **AWS CloudWatch: Security & Infrastructure Dashboards**
    👉 [Coming Soon / Em breve]
    *Foco: Centralização de logs de segurança, métricas de instâncias EC2 e alertas de billing/uso de recursos.*

### 📈 **Visualização & Data Analysis**
* **Grafana & Prometheus: Security Compliance Metrics**
    👉 [Coming Soon / Em breve]
...
- **Containerization:** Padronização do ambiente de observabilidade com Docker.
